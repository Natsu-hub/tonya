...
<div class="p-to-lineUp__img">
  <div class="p-to-lineup__inner l-inner">
    <div class="p-to-lineUp__card">
      <h3 class="p-to-lineUp__head">からだに優しく、<br class="u-mobile">美味しいお弁当を<br>ご自宅へお届けします</h3>
...
毎月の献立" width="482" height="318" loading="lazy">
        ...
        <h3 class="p-top-menu__head">栄養バランスや旬を考えた<br>毎月の献立</h3>
      ...
      <div class="p-top-menu__right">
        <div class="p-top-menu__right-box">
          <div class="p-top-menu__right-content">
            <h4 class="p-top-menu__right-head">毎日手作業でダシをとり<br>あたたかな手作りの味</h4>
        ...
        <div class="p-top-menu__right-box p-top-menu__right-box--reverse">
          <div class="p-top-menu__right-content">
            <h4 class="p-top-menu__right-head">農家も喜ぶ全量買取<br>契約栽培</h4>
