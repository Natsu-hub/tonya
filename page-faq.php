                    ...
                    <li class="p-faq__list">
                        ...
                        <div class="p-faq__answer">
                            ...
                            <div class="p-faq__answer-text">
                                配達エリアは高崎市の新高尾、塚沢、東部、浜尻、中川、六郷、大類、京ヶ島、中居、城東の小学校地域となりますが、これ以外の地域でも対象となるケースもありますので、その場合は直接お問い合わせください。
                            </div>
                        </div>
                    </li>
                    <li class="p-faq__list">
                        ...
                        <div class="p-faq__answer">
                            ...
                            <div class="p-faq__answer-text">
                                ・骨抜きの魚の使用等、やわらかさ・食べやすさ・大きさに配慮<br>・自然な食感と家庭的な味を毎食日替りで提供することで、食材の偏りがなく栄養バランスも良くなります。<br>・持病をお持ちの方向けのメニューは朝食もご用意しております
                            </div>
                        </div>
                    </li>
                    <li class="p-faq__list">
                        ...
                        <div class="p-faq__answer">
                            ...
                            <h2 class="p-faq__answer-text">
                                はい。１日分だけのご注文も可能ですが、ほとんどの方は定期的な申込み（１か月、３か月、６ヵ月、１年）です。電話番号へおかけいただくか、<a href="https://saporuto.com/contact/" target="_blank" rel="noopener noreferrer">こちらのフォーム</a>へお気軽にご連絡ください。<br>また、ご注文をご希望の場合は注文希望日2週間前の火曜日までにご連絡ください。なお、キャンセルは前日の17時までにご連絡いただき、当日キャンセルの場合はキャンセル料が発生します。（ご注文いただいた金額分）
                            </h2>
                        </div>
                    </li>
                    <li class="p-faq__list">
